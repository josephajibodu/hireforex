        ...
        return [
            ...
            Actions\Action::make('assign_roles')
                ...
                ->action(function (User $record, array $data) {
                    try {
                        abort_if(
                            ! auth()->user()->hasPermissionTo(SystemPermissions::ManageFunds),
                            403,
            ...
            Actions\Action::make('fund_user')
                ...
                ->action(function (User $record, array $data) {
                    try {
                        ...
                        switch ($data['action']) {
                            case 'credit':
                                $record->credit(WalletType::Main, $data['amount'], $data['reason']);
                                break;
                            case 'debit':
                                $record->debit(WalletType::Main, $data['amount'], $data['reason']);
