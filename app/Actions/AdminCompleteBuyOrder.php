...
class AdminCompleteBuyOrder
{
    ...
    public function __invoke(Order $order): void
    {
        ...
        DB::transaction(function () use ($order) {
            ...
            $sellAdvert->user->debit(WalletType::Trading, $coinAmount / 100, "[Admin] Sell order completion for order #$order->reference");
            ...
            $buyer = $order->buyer;
            $buyer->credit(WalletType::Reserve, $coinAmount / 100, "[Admin] Buy order completion for order #$order->reference");
