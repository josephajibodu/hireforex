            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-xl font-semibold text-brand-600">Profx</h3>
                    ...
                    <div class="space-y-2 text-sm mb-4">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="flex gap-1">
                                <span class="w-3 h-3 rounded-full text-xs flex items-center justify-center font-bold bg-green-500 text-white">W</span>
                                <span class="w-3 h-3 rounded-full text-xs flex items-center justify-center font-bold bg-red-500 text-white">L</span>
                                <span class="w-3 h-3 rounded-full text-xs flex items-center justify-center font-bold bg-green-500 text-white">W</span>
                                <span class="w-3 h-3 rounded-full text-xs flex items-center justify-center font-bold bg-red-500 text-white">L</span>
                                <span class="w-3 h-3 rounded-full text-xs flex items-center justify-center font-bold bg-green-500 text-white">W</span>
                            </div>
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-xl font-semibold text-brand-600">SmartSwinger</h3>
                        <div class="text-right">
                            <div class="text-2xl font-bold text-green-600">122%</div>
                            <div class="text-sm text-gray-500">Returns</div>
                        </div>
                    </div>
                    <div class="space-y-2 text-sm mb-4">
                        ...
                        <div class="flex justify-between">
                            <span class="text-gray-600">Experience:</span>
                            <span class="font-medium">6 years</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Min Capital:</span>
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-xl font-semibold text-brand-600">Pipsniper</h3>
                        <div class="text-right">
                            <div class="text-2xl font-bold text-green-600">170%</div>
                            <div class="text-sm text-gray-500">Returns</div>
                        </div>
                    </div>
                    <div class="space-y-2 text-sm mb-4">
